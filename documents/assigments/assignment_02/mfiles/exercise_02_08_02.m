...
l=2; %Dimensionality
m1=[-10 0; 0 -10; 10 0; 0 10; -10 20; 10 20; 20 10; 20 -10]'; % centroids of the first class
m2=[-10 -10; 0 0; 10 -10; -10 10;10 10; 20 20; 20 0; 0 20]'; % centroids of the second class 
[l,c1]=size(m1); 
[l,c2]=size(m2);
...
k=40; %number of hidden layer nodes. Also use 4 and 10 nodes
lr=.01; %learning rate
