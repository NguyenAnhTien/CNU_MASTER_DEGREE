...
\newpage
\begin{homeworkProblem}
\matlabscript{example_figure_3_7_a}{Another M-Function for Intensity Transformations}
\matlabscript{twomodegauss}{changeclass function}
\matlabscript{manualhist}{changeclass function}
...
\centering
    \begin{subfigure}[h]{0.3\textwidth}
        \centering
        \includegraphics[height=1.2in]{figure_3_7_c.jpg}
        \caption{Using block code 2 or 3}
    \end{subfigure}%
    \begin{subfigure}[h]{0.3\textwidth}
        \centering
