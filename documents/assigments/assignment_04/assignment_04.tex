...
\textbf{Case 3: } $m_1 = [1, 1]^T$, $S_1 = 0.2I$, $m_2 = [4, 4]^T$, $S_2=1.9I$
...
\begin{homeworkProblem}
\maketitle
\subsection{Exercise 4.8.3}
\matlabscript{mfiles/exercise_04_08_03}{Source codes}

\newpage

When we change the numbers of the highest-ranked features: four, eight, ten and twenty. We figured out that the result is not changed.
...
\maketitle
\subsection{Exercise 4.7.2}
\matlabscript{mfiles/exercise_04_07_03}{Source codes}

\newpage

Repeat the experiment for all of the 3-feature combinations. The results is as same as Example 4.7.3.
