...
The Matlab provides \textbf{imnoise} function to add noises to a image.
The basic syntax:
  \begin{lstlisting}
     g = imnoise(f, type, parameters)
  \end{lstlisting}
  \begin{itemize}
     \item \textbf{f} is the input image.
     \item \textbf{type} takes values such that \textbf{"gaussian"}, \textbf{"localvar"}, \textbf{"salt & peppr"}, \textbf{speckle} and \textbf{poisson}.
     \item \textbf{parameters} will be depended on values of \textbf{"type"}.
  \end{itemize}
\end{homeworkProblem}
%----------------------------------------------------------------------------------------
