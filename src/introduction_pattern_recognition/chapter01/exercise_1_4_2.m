...
%comment result:
%The error probabilities for the Euclidean is 11.01%
%The error probabilities for the Mahalanobis is 10.21%
%The error probabilities for the Bayesian is 9.71%